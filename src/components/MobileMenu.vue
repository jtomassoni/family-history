    ...
    <div v-if="isOpen" class="mobile-menu">
      ...
      <div class="mobile-menu-content" :class="{ 
        ...
        <div class="menu-side menu-auth">
          ...
          <p class="auth-subtitle">{{ isSignup ? 'Join the Tomassoni family network' : 'Choose how you\'d like to continue' }}</p>
        ...
        <div class="menu-side menu-email">
          <h2 class="auth-title">{{ isSignup ? 'Create Account' : 'Welcome Back' }}</h2>
          <p class="auth-subtitle">{{ isSignup ? 'Join the Tomassoni family network' : 'Sign in to your account' }}</p>
